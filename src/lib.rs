...
use models::page::UpdatePageQuery;
...
impl NotionApi {
    ...
    /// Update a page properties by [PageId].
    pub async fn update_page<Id, Q>(&self, page_id: Id, query: Q) -> Result<Page, Error>
    where
        Id: AsIdentifier<PageId>,
        Q: Into<UpdatePageQuery>,
    {
        let result = self
            .make_json_request(
                self.client
